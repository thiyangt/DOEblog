...
date: "2021-11-16/ 2021-11-19/ 2021-11-26"
output:
...
ggplot(data=df.pl, aes(x=tip, y=value, col=tip)) +  geom_point(size=3) + scale_color_manual(values=c("#1b9e77", "#d95f02", "#7570b3", "#e7298a"))+ stat_summary(fun.y=mean, col="black", size=1, alpha=0.7)
```
