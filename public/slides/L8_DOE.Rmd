...
#create data
df <- data.frame(sunlight = factor(rep(c('Low', 'Medium', 'High'), each = 15, times = 2)),
                 water = factor(rep(c('Daily', 'Weekly'), each = 45, times = 2)),
                 growth = c(rnorm(15, 9, 3), rnorm(15, 10, 3), rnorm(15, 13, 3),
                            rnorm(15, 8, 3), rnorm(15, 10, 3), rnorm(15, 12, 3)))
df
```
